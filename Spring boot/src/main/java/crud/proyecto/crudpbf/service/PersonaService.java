...
public class PersonaService {
    ...
    // public List<Persona> findAll(Sort sort) {return personaRepository.findAll(sort);}

    // public Page<Persona> findAll(Pageable pageable) {return personaRepository.findAll(pageable);}
